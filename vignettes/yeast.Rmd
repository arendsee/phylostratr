...
saccharomyces <- list(
  list(
    name='s6',
    list(name='Saccharomyces_eubayanus', protein_file='yeast/eubayanus.faa'),
    list(name='Saccharomyces_uvarum', protein_file='yeast/uvarum.faa'),
    list(
      name='s5',
      list(name='Saccharomyces_arboricola', protein_file='yeast/arboricola.faa'),
      list(
        name='s4',
        list(name='Saccharomyces_kudriavzevii', protein_file='yeast/kudriavzevii.faa'),
        list(
          name='s3',
          list(name='Saccharomyces_mikatae', protein_file='yeast/mikatae.faa'),
          list(
            name='s2',
            list(name='Saccharomyces_paradoxus', protein_file='yeast/paradoxus.faa'),
            list(
              name='s1',
              list(name='Saccharomyces_cerevisiae', protein_file='yeast/cerevisiae.faa')
            )
          )
        )
      )
...
uniprot_filter <- make_do_if_over(5, take_first)

# Get all UniProt proteomes
deep_strata <- uniprot_cousins(4932, filter=uniprot_filter) %>%
