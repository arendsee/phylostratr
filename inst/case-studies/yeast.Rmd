...
```{r sc_custom_tree, fig.width=5, fig.height=5, fig.cap="Custom tree for Saccharomyces genus. The internal nodes s1-s5 are arbitrary names for the new internal nodes that are absent from the NCBI common tree."}
