...
sigmats[[1]][[1]]@xlab = "Phylostratum (Bonferoni-adusted p-value < 0.05)"
sigmats[[1]][[1]]@ylab = "Phylostratum (Holm-adusted p-value < 0.05)"

sigmats[[1]][[2]]@xlab = "Phylostratum (Bonferoni-adusted p-value < 1e-5)"
sigmats[[1]][[2]]@ylab = "Phylostratum (Holm-adusted p-value < 0.05)"

sigmats[[2]][[1]]@xlab = "Phylostratum (Bonferoni-adusted p-value < 1e-5)"
sigmats[[2]][[1]]@ylab = "Phylostratum (Bonferoni-adusted p-value < 0.05)"
