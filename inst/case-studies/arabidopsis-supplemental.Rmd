...
```{r prot_table, at_protreport, cache=FALSE, results='asis'}
...
```{r revenant_table, cache=TRUE, results='asis'}
...
```{r revenant_table_2, cache=TRUE, results='asis'}
...
```{r revenant_table_3, cache=TRUE, results='asis'}
revenants %>%
    dplyr::group_by(mrca) %>%
...
```{r, at_tips_summary, results='asis'}
